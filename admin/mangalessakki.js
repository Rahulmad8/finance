...
var ref = database.ref('MangalEssakiClient');
...
function gotData(data){
  ...
  // console.log(container);
    ...
    for (i=0; i<keys.length; i++){
        ...
        let messageclients= clientMessage[k].message_clients;
        let phonenumber= clientMessage[k].phone_numbers;
        let username= clientMessage[k].user_names;
